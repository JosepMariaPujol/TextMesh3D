...
namespace Softgraph.TextMesh3D.Runtime
{
    ...
    {
        public static HalfEdgeData2 GenerateTriangulation(HashSet<Vector2> points, HalfEdgeData2 triangulationData)
        {
            ...
            Triangle2 superTriangle = new Triangle2(new Vector2(-100f, -100f), new Vector2(100f, -100f), new Vector2(0f, 100f));
        ...
        private static void InsertNewPointInTriangulation(Vector2 p, HalfEdgeData2 triangulationData, ref int missedPoints, ref int flippedEdges)
        {
            ...
            while (trianglesToInvestigate.Count > 0)
            {
                ...
                Vector2 b = edgeToTest.prevEdge.v.position;
                Vector2 c = edgeToTest.nextEdge.v.position;
        ...
        private static void AddTrianglesOppositePToStack(Vector2 p, Stack<HalfEdge2> trianglesOppositeP, HalfEdgeData2 triangulationData)
        {
